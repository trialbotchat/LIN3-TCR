...
Amid = ki.getProfile().u5739933753db9a87eba1f0a497ef8567
Bmid = kk.getProfile().u8451873ac51eb96a4d53f1e5b5806c46
...
#-----------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "ngitung sik...")
